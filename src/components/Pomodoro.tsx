...
import { saveToLc, getToLc } from "../utils/localStorageOperations";
...
function Pomo(props: typeProps) {
  ...
  }, [working, cycles, configureRestingTime, resting, mainTime,
    cyclesQtd, numberOfPomodoros, configureRestingTime, props.cycles,]);

  useInterval(() => {
    setMainTime(mainTime - 1)
    if (working) {
      setTimeWorked(timeWorked + 1);
      saveToLc({ cicles: cyclesQtd, timeStudy: timeWorked })
